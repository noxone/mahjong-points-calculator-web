        ...
        private fun get(languageKey: String): Language? =
            when (languageKey) {
                DEFAULT_LANGUAGE -> Language(mapOf(
                    ...
                    StringKeys.PUNG_BASETILE_OPEN to "Pung of minor tiles (open)",
                    StringKeys.PUNG_BASETILE_CLOSED to "Pung of minor tiles (closed)",
                    StringKeys.PUNG_MAINTILE_OPEN to "Pung of major tiles (open)",
                    StringKeys.PUNG_MAINTILE_CLOSED to "Pung of major tiles (closed)",
                    StringKeys.KANG_BASETILE_OPEN to "Kang of minor tiles (open)",
                    StringKeys.KANG_BASETILE_CLOSED to "Kang of minor tiles (closed)",
                    StringKeys.KANG_MAINTILE_OPEN to "Kang of major tiles (open)",
                    StringKeys.KANG_MAINTILE_CLOSED to "Kang of major tiles (closed)",
                    ...
                    StringKeys.PUNG_DRAGONS to "",
                    StringKeys.KANG_DRAGONS to "",
                    StringKeys.PUNG_PREVAILING_WIND to "",
                    StringKeys.KANG_PREVAILING_WIND to "",
                    StringKeys.THREE_CLOSED_PUNGS to "",
